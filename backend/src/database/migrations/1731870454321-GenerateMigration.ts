...
export class GenerateMigration1731870454321 implements MigrationInterface {
    name = 'GenerateMigration1731870454321'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`banco_talentos\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nome_completo\` varchar(50) NOT NULL, \`email\` varchar(50) NOT NULL, \`telefone\` varchar(11) NOT NULL, \`descricao\` text NOT NULL, \`cv_data\` longblob NOT NULL, \`cv_type\` varchar(50) NOT NULL, \`vagaId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
